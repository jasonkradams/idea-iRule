...
final class IRulesLineMarkerProvider extends RelatedItemLineMarkerProvider {
    ...
    protected void collectNavigationMarkers(@NotNull PsiElement element,
        ...
        // The literal expression must start with the IRules language literal expression
        ...
        // Get the IRules language property usage
        ...
        final List<IRulesProperty> properties = IRulesUtil.findProperties(project, possibleProperties);
        if (!properties.isEmpty()) {
            // Add the property to a collection of line marker info
            NavigationGutterIconBuilder<PsiElement> builder =
                    NavigationGutterIconBuilder.create(IRulesIcons.FILE)
                            .setTargets(properties)
                            .setTooltipText("Navigate to IRules language property");
