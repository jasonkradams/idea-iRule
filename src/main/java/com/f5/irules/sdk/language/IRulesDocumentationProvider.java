 ...
 */
final class IRulesDocumentationProvider extends AbstractDocumentationProvider {

    /**
     * For the IRules Language, we don't have online documentation. However, if your language provides
    ...
    /**
     * Extracts the key, value, file and documentation comment of a IRules key/value entry and returns
     * a formatted representation of the information.
     */
    @Override
    public @Nullable String generateDoc(PsiElement element, @Nullable PsiElement originalElement) {
        if (element instanceof IRulesProperty) {
            final String key = ((IRulesProperty) element).getKey();
            final String value = ((IRulesProperty) element).getValue();
            final String file = SymbolPresentationUtil.getFilePathPresentation(element.getContainingFile());
            final String docComment = IRulesUtil.findDocumentationComment((IRulesProperty) element);
    ...
    /**
     * Provides the information in which file the IRules language key/value is defined.
     */
    @Override
    ...
    /**
     * Provides documentation when a IRules Language element is hovered with the mouse.
     */
    @Override
